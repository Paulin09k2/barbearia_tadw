...
<body class="bg-gradient-to-b from-[#0b0f16] to-[#0d1117] text-white min-h-screen flex flex-col items-center">
  ...
  <header class="fixed w-full bg-[#0d1b2a]/90 backdrop-blur-md flex justify-between items-center px-10 py-4 shadow-lg z-50">
    <div class="flex items-center gap-3">
      ...
      <span class="text-2xl font-semibold text-white">Barbearia Elite</span>
    </div>
    <nav class="space-x-8 text-lg">
      <a href="./index.php" class="hover:text-gray-300 transition">Início</a>
      <a href="./gerenciador.php" class="hover:text-gray-300 transition">Gerenciar</a>
      <a href="./avaliacao.php" class="hover:text-gray-300 transition">Avaliações</a>
      <a href="./servico.php" class="hover:text-gray-300 transition">Serviços</a>
      <a href="../formBarbeiro.php?id=<?= $idusuario; ?>" class="hover:text-gray-300 transition">Editar Perfil</a>
  ...
  <main class="flex flex-col items-center mt-32 px-6 fade-in">
    ...
    <!-- ======= CARD DE RESUMO ======= -->
    <section class="bg-[#141a22] p-8 rounded-2xl shadow-lg border border-[#1f2937] w-full max-w-xl text-center hover:shadow-white/20 transition-transform transform hover:-translate-y-2">
      <?php
      $resumo = obterResumoPainelBarbeiro($conexao, $barbeiro['id_barbeiro']);

      echo "<h3 class='text-2xl font-semibold mb-4 text-white'>Resumo do Barbeiro</h3>";
      ...
      echo "<h4 class='text-xl font-semibold mb-3 text-white'>Próximos Agendamentos</h4>";
    ...
    <a href="./gerenciador.php" class="mt-10 inline-block bg-white text-black font-semibold px-8 py-3 rounded-xl shadow-lg hover:bg-gray-200 transition-transform transform hover:scale-105">
